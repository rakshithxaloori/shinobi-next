  ...
  <div className={styles.container}>
    ...
    <div className={styles.textBody}>
      ...
      <p>
        ...
        using the app. You&apos;re not allowed to copy, or modify the app, any
        part of the app, or our trademarks in any way. You&apos;re not allowed
      ...
      <p>
        ...
        phone&apos;s security features and it could mean that the Shinobi app
      ...
      <div>
        ...
        <ul>
          ...
          <li className={styles.listItem}>
            <Link href="https://www.facebook.com/legal/terms/plain_text_terms">
              <a
                className={styles.externalLink}
                target="_blank"
                rel="noopener noreferrer"
      ...
      <p>
        You should be aware that there are certain things that Shinobi will not
        ...
        or provided by your mobile network provider, but Shinobi cannot take
      ...
      <p>
        Along the same lines, Shinobi cannot always take responsibility for the
        ...
        avail the Service, Shinobi cannot accept responsibility.
      </p>
      <p>
        With respect to Shinobi&apos;s responsibility for your use of the app,
        ...
        we can make it available to you. Shinobi accepts no liability for any
      ...
      <p>
        ...
        want to keep using the app. Shinobi does not promise that it will always
      ...
      <p>These terms and conditions are effective as of 2021-10-11</p>
      <p>
